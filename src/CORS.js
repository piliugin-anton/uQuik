(function () {
  ...
  function configureMethods (options) {
    ...
    if (methods.join) {
      methods = fastArrayJoin(options.methods, ',') // .methods is an array, so turn it into a string
    }
    return {
  ...
  function configureAllowedHeaders (options, req) {
    ...
    if (!allowedHeaders) {
      ...
      allowedHeaders = fastArrayJoin(allowedHeaders, ',') // .headers is an array, so turn it into a string
    }
  ...
  function configureExposedHeaders (options) {
    ...
    if (!headers) {
      ...
      headers = fastArrayJoin(headers, ',') // .headers is an array, so turn it into a string
    }
